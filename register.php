...
if(isset($_POST['btn-signup'])) {
 ...
 //$hashed_password = password_hash($userPass); // this function works only in PHP 5.5 or latest version
 ...
 if ($count==0) { 
  ...
  $query = "INSERT INTO customer(userName,userPassword,customerName,customerAddress,customerPhone,customerEmail) VALUES('$userName','$userPass','$customerName','$customerAddress','$customerPhone','$customerEmail')";
